...
static void
addresses__iphone8_4__17G68() {
	ADDRESS(IOUserClient__vtable)                = SLIDE(0xFFFFFFF0070ABEE0); 
	ADDRESS(IORegistryEntry__getRegistryEntryID) = SLIDE(0xFFFFFFF0075FF6F4);
}
...
static struct platform_initialization addresses[] = {
	...
	{ "iPhone8,4", 		   "17G68",  addresses__iphone8_4__17G68   },
};
