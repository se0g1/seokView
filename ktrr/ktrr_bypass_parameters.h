...
extern uint64_t zone_map_min_addr;
extern uint64_t zone_map_max_addr;
extern uint64_t zone_metadata_region_min;
extern uint64_t zone_metadata_region_max;
extern uint64_t ADDRESS(zone_base);
extern uint64_t ADDRESS(kvtophys);
...
extern uint64_t ADDRESS(zone_map_min_addr);
extern uint64_t ADDRESS(zone_map_max_addr);
extern uint64_t ADDRESS(zone_metadata_region_min);
extern uint64_t ADDRESS(zone_metadata_region_max);
extern uint64_t ADDRESS(zone_base);
