...
static struct platform_initialization offsets[] = {
	...
	{ "iPhone8,4",             "17G68",        offsets__iphone8_4__17G68 },
};
...
static void
parameters__iphone8_4__17G68() {
	gPhysBase                   = kernel_read64(SLIDE(0xFFFFFFF007096138));
	gVirtBase                   = kernel_read64(SLIDE(0xFFFFFFF007096140));
	rorgn_begin                 = kernel_read64(SLIDE(0xFFFFFFF007096418));
	...
	ADDRESS(ml_phys_write_data) = SLIDE(0xFFFFFFF0071F0B90);
	ADDRESS(ml_io_map)          = SLIDE(0xFFFFFFF0071F63D0);
	ADDRESS(ldr_w0_x0__ret)     = SLIDE(0xFFFFFFF007106378); // ml_io_read_32
	ADDRESS(str_w1_x0__ret)     = SLIDE(0xFFFFFFF007106404); // ml_io_write_32
	ADDRESS(CpuDataEntries)     = SLIDE(0xFFFFFFF0077123D0);
}
...
static struct platform_initialization parameters[] = {
	...
	{ "iPhone8,4", 			   "17G68",  parameters__iphone8_4__17G68  },
};
